...
class dns::server (
  ...
  Array $necessary_packages      = $dns::server::params::necessary_packages,
  $ensure_packages               = $dns::server::params::ensure_packages,
  Stdlib::Absolutepath $cfg_dir  = $dns::server::params::cfg_dir,
  Stdlib::Absolutepath $cfg_file = $dns::server::params::cfg_file,
